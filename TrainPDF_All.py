...
data_directory = "E:\\Py64\\env_1\\Scripts\\TrainSamples" #for running at home laptop
...
joblib.dump(selected_features, 'selected_features_all.pkl')
joblib.dump(classifier, 'classification_model_all.pkl')


# Load the saved selected features
selected_features = joblib.load('selected_features_all.pkl')
print("Selected Features:")
print(selected_features)

# Load the saved classifier
classification_model = joblib.load('classification_model_all.pkl')
